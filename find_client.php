...
if (($this->session->userdata('permisson')==4)) {
    ...
    <h1>Vyhledání klienta</h1>

    <div>
    <?php echo form_open('Adviser/findClient')?>
    
        <table class="form_table">            
            <tr>
                <td width="240">
                    <b>Vyhledávací pole</b> v sekci klientů:
                </td>
                <td>					               
					<?php echo '<div class="button-group">'; ?>
						<?php echo form_input('findClientText',$input,'class="myTextArea" style="width:400px;float:left"'); ?>
						<?php echo form_submit('findClientSubmit', 'Vyhledat zaměstnance', 'class="button" style="margin-left:3px"')?>
					</div>
                </td>
                <td>
                </td>                
	...
	<?php echo form_close();?>
		<table class="form_table">
			<tr>
                <td>
					Pro <b>konkretní</b> vyhledání klienta je možné použit jeden z nasledujícich postupov:
				</td>
			</tr>
			<tr>
				<td>
					<ul class="list_ul">
						<li> Zadanie <b>identifikačního čísla</b> klienta.
						<li> Zadanie <b>přihlašovacího jména </b> klienta.
						<li> Zadanie <b>jména</b> klienta.
		...
		<table class="form_table">
			<tr>
                <td>
					V případe, kdy neznáte konkrétní údaje klienta, můžete zadat:
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
                <td>
					<ul class="list_ul">
						...
						<li>V případe, kdy vyhledáni <b>vráti jenom jeden nájdený záznam</b>, budete automaticky přesměrován na <b>detail</b> klienta.
						<li>V případe, kdy vyhledáni <b>vráti více ako jeden nájdený záznam</b>, budete automaticky přesměrován na <b>seznam</b> klientů.
					<ul>
				</td>
			</tr>
       </table>   
