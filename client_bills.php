		...
		if ($bills != false) {			
					foreach ($bills as $bill) {
							...
							<div style="display:inline-block; margin-top:10px">
								<div style="margin-right:30px; width:90px; font-size:8px;"><?php 
										echo '<span style="margin-left:13px">'.$bill->BILL_CODE.'</span>'; ?>
										<a href="<?php echo base_url('PdfMaker/showBill/'.$bill->BILL_ID) ?>">
											<img border="0" width="80" style="margin-left:28px; margin-top:5px" src="<?php echo base_url("images/fomr2.png")?>">
										</a> <?php
								?>	
								</div>
							</div><?php
