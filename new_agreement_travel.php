...
showMenuAdmin(); 
	...
	<?php echo form_open('Admin/newTravelAgreement');?>
    <div>
		...
		<?php echo '<div class="button-group" style="float:left; margin-top:15px; margin-left: 15px">'; ?>
			<a href="<?php echo base_url('Admin/redirectChooseNewAgreement/1')?>" onclick="" class="button" id="newUserTrace">Zpět</a>
			<a href="<?php echo base_url('Admin/redirectChooseNewAgreement/2')?>" onclick="" class="button" id="newUserTrace">Vyčistit</a>
