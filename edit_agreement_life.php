	...
	<div id="dialogEmployeePDF" class="dialogEmployee">
			...
			<div style=" text-align:center;">
				<div class="button-group" style="padding-top: 15px;">
					...
					<a href="<? echo base_url('Admin/acceptLifeAgreementPDF/'.$agreement_life->LIFE_ID); ?>" class="button">Udáje sú prekontrolované a chcem vygenerovať zmluvu</a>
				</div>
			</div>
		</div>
		...
		<div id="dialogEmployeeStorno" class="dialogEmployee">
			...
			<div style=" text-align:center;">
				<div class="button-group" style="padding-top: 15px;">
					...
					<a href="<? echo base_url('Admin/stornoLifeAgreement/'.$agreement_life->LIFE_ID); ?>" class="button">Áno, chcem stornovať zmluvu</a>
				</div>
			</div>
		</div>
		...
		<div id="dialogEmployeeFire" class="dialogEmployee">
			...
			<div style=" text-align:center;">
				<div class="button-group" style="padding-top: 15px;">
					...
					<a href="<? echo base_url('Admin/fireLifeAgreement/'.$agreement_life->LIFE_ID); ?>" class="button">Áno, chcem deaktivovať zmluvu</a>
				</div>
			</div>
		</div>
