...
$counter=0;
	...
	echo form_open('Adviser/editTravelAgreement/'.$newAgreementUser['newTravelId']);
	...
	<div id="dialogEmployeePDF" class="dialogEmployee">
		...
		<div style=" text-align:center;">
			<div class="button-group" style="padding-top: 15px;">
				...
				<a href="<? echo base_url('Adviser/acceptTravelAgreementPDF/'.$newAgreementUser['newTravelId']); ?>" class="button">Udáje sú prekontrolované a chcem vygenerovať zmluvu</a>
			</div>
		</div>
	</div>
	...
	<div id="dialogEmployeeStorno" class="dialogEmployee">
		...
		<div style=" text-align:center;">
			<div class="button-group" style="padding-top: 15px;">
				...
				<a href="<? echo base_url('Adviser/stornoTravelAgreement/'.$agreement->TRAVEL_ID); ?>" class="button">Áno, chcem stornovať zmluvu</a>
			</div>
		</div>
	</div>
	...
	<div id="dialogEmployeeFire" class="dialogEmployee">
		...
		<div style=" text-align:center;">
			<div class="button-group" style="padding-top: 15px;">
				...
				<a href="<? echo base_url('Adviser/fireTravelAgreement/'.$agreement->TRAVEL_ID); ?>" class="button">Áno, chcem deaktivovať zmluvu</a>
			</div>
		</div>
	</div>
